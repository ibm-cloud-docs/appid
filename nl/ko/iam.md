...
조치는 서비스에서 수행되도록 허용된 조작으로서 {{site.data.keyword.Bluemix_notm}} 서비스에 의해 정의되고 사용자 정의됩니다. 그리고 조치는 IAM 사용자 역할에 맵핑됩니다. {{site.data.keyword.appid_short_notm}}의 경우에는 다음 조치가 존재합니다. 
...
시작하기 전에:
* [{{site.data.keyword.Bluemix_notm}} CLI](/docs/cli/reference/bluemix_cli/get_started.html)를 설치하십시오. 
