...
<table>
  ...
  <tr>
    <td>[권한 및 인증](/docs/services/appid?topic=appid-key-concepts#key-concepts)을 모바일 및 웹 앱에 추가해야 하지만 안전한 백그라운드를 갖추고 있지 않습니다.</td>
...
{{site.data.keyword.appid_short_notm}}는 지역 서비스이기 때문에 자동화된 교차 지역 장애 복구 또는 교차 지역 재해 복구를 제공하지 않습니다. 하지만 {{site.data.keyword.appid_short_notm}}는 개발자가 수동으로 해당 서비스 구성을 {{site.data.keyword.appid_short_notm}}의 다른 인스턴스와 동기화하기 위해 사용할 수 있는 <a href="https://us-south.appid.cloud.ibm.com/swagger-ui/#/" target="_blank">광범위한 API<img src="../../icons/launch-glyph.svg" alt="외부 링크 아이콘"></a>를 제공합니다.
