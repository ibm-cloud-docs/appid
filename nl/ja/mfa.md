...
1. {{site.data.keyword.appid_short_notm}} のログイン・ウィジェットが表示されたら、ユーザーは Cloud Directory のユーザー資格情報を入力します。 この資格情報は、E メールまたはユーザー名と、それに対応するパスワードです。 Cloud Directory のユーザー資格情報が、最初の認証要素となります。
