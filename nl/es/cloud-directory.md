...
1. Asegúrese que el directorio en la nube está activado como proveedor de identidad y establezca **Permitir a los usuarios registrarse y restablecer su contraseña** en **Activado**. Puede seguir agregando usuarios a través de la consola cuando está definido en **Desactivado**, pero solo para desarrollo.
2. Configure los detalles de su remitente. Especifique la dirección de correo electrónico desde la que enviará los mensajes, el remitente y a quién pueden responder los usuarios.
  **Nota**: Asegúrese de dejar tiempo suficiente para que un usuario pulse el enlace al configurar el URL de acción. El usuario debe verificar su correo electrónico para tener ciertas opciones, como la capacidad de solicitar un restablecimiento de su contraseña.
3. Determine los tipos de correo electrónico que recibe un usuario y la información del remitente.
4. Utilizando las plantillas proporcionadas, personalice sus mensajes con su marca o con mensajes personalizados. Para obtener más información, consulte [Gestión de mensajes](/docs/services/appid/cloud-directory.html#cd-messages).
...
Hay varios tipos de mensajes que puede enviar a sus usuarios. Puede elegir enviar el mensaje de ejemplo que está programado en la IU o puede personalizar el contenido para conseguir una experiencia más personal con la app.

<dl>
  <dt>Bienvenido</dt>
    <dd><p>Puede dar la bienvenida a su aplicación a un usuario a través de correo electrónico una vez se registre. Para dar la bienvenida y retener a los usuarios, haga su mensaje tan interactivo como sea posible.</p>
    <table>
      <thead>
...
**NOTA**: {{site.data.keyword.appid_short_notm}} utiliza <a href="https://www.sendgrid.com" target="_blank">SendGrid <img src="../../icons/launch-glyph.svg" alt="Icono de enlace externo"></a> como servicio de entrega de correo. Todos los correos electrónicos se envían utilizando una única cuenta de SendGrid.
...
<img usemap="#options-map" border="0" class="image" id="options" src="images/options.png" width="750" alt="Pulse en un icono de lenguaje de SDK para empezar a utilizar el directorio en la nube en sus apps." style="width:750px;" />
<map name="options-map" id="options-map">
<area href="branded.html#branded-ui-android" alt="Gestión de la experiencia de inicio de sesión con el SDK de Android" shape="rect" coords="187, 6, 305, 120" />
<area href="branded.html#branded-ui-ios-swift" alt="Gestión de la experiencia de inicio de sesión con el SDK de iOS Swift." shape="rect" coords="333, 6, 448, 125" />
<area href="branded.html#branded-ui-nodejs" alt="Gestión de la experiencia de inicio de sesión con el SDK de Node.js." shape="rect" coords="472, 7, 590, 121" />
</map>
