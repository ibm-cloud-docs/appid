...
Create a project in the [Google Cloud Platform](https://console.cloud.google.com/home/dashboard){: external}, configure the project to serve web clients, and obtain a client ID and secret.

1. Create a project.
2. Open [credentials page](https://console.cloud.google.com/apis/dashboard){: external} of the Google APIs console.
