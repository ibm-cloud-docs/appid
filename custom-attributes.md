...
With {{site.data.keyword.appid_full}}, you can save and access your custom attributes through API endpoints. You can see how creating user profiles can make a difference in this blog: <a href="https://www.ibm.com/blogs/bluemix/2017/03/introducing-ibm-bluemix-app-id-authentication-profiles-service-app-developers/" target="_blank">Introducing {{site.data.keyword.appid_short_notm}}<img src="../../icons/launch-glyph.svg" alt="External link icon"></a>.
{: shortdesc}
