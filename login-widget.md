...
## Displaying the default cloud directory screens
{: #cd-default}
...
### Displaying the default cloud directory screens with the Android SDK
{: #cd-default-android}

With cloud directory enabled, you can display the default screens with the Android SDK. You can choose the combination of the screens that you'd like your users to be able to interact with.
{: shortdesc}

If you want to use screens that you've already created, check out the docs for [branding your UI](/docs/services/appid/branding.html).
...
### Displaying the default cloud directory screens with the iOS Swift SDK
{: #cd-default-ios-swift}

With cloud directory enabled, you can call default screens with the iOS Swift SDK. You can choose the combination of the screens that you'd like your users to be able to interact with.
{: shortdesc}
...
### Displaying the default cloud directory screens with the Node.js SDK
{: #cd-default-nodejs}
