...
## Customizing the default sign-in screens
{: #login-widget}
...
After you've configured your settings for [social identity providers](/docs/services/appid/identity-providers.html), or [cloud directory](/docs/services/appid/cloud-directory.html), click on the language of your choice in the following image to start implementing the code.
