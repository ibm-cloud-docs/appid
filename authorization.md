...
When a user chooses to sing-in to an app, they become an identified user. Information about the user is obtained from the identity provider that they choose to sing-in with. They receive access and identity tokens that contain information about the user.
