...
Token configurations can be enabled and disabled through the App ID dashboard. For more information about your configuration options, check out [Managing tokens](/docs/services/appid?topic=appid-managing-idp).
</br>
</br>
