...
Get started with {{site.data.keyword.appid_short}} by setting up the service in your application. If you don't see your app language in the listed SDKs, don't worry! You can use the API with any language that your app might be written in.
{: shortdesc}
