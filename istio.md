...
![App Identity and Access Adapter architecture diagram](images/istio-adapter.svg){: caption="Multicloud deployment - achieved with the App Identity and Access Adapter" caption-side="bottom"}
