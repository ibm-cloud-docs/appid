...
[Access and identity tokens](https://console.test.cloud.ibm.com/docs/services/appid/authorization.html#tokens) can be used to identify users and securely access protected resources.
...
[Refresh Tokens](https://console.test.cloud.ibm.com/docs/services/appid/authorization.html#refresh-tokens) are used exclusively for retrieving new access and identity tokens. If using a confidential client, such as a backend server, these can be securely persisted allowing them to have much longer lifespans.
