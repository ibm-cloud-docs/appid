...
<table>
  ...
  <tr>
    ...
    <td>Get the token expiration configuration.</td>
    <td>Can be found in the <strong>Activity Log</strong> in the <strong>Overview</strong> tab.</td>
  </tr>
  <tr>
    <td><code>read.isProfilesActive</code></td>
    <td>View whether the profile configuration is active.</td>
    <td>Can be found in the <strong>Activity Log</strong> in the <strong>Overview</strong> tab.</td>
  </tr>
  <tr>
    <td><code>update.isProfilesActive</code></td>
    <td>Update whether the profile configuration is active.</td>
    <td>Can be found in the <strong>Activity Log</strong> in the <strong>Overview</strong> tab.</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td>Get a list of your Cloud Directory users.</td>
    <td> </td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td>Start the forgot password process.</td>
    <td> </td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td>Start the sign up process.</td>
    <td> </td>
  </tr>
  <tr>
