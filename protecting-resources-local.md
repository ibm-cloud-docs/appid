...
```swift
 ...
 let region = AppID.REGION_UK; //set your App ID application region here. Currently possible values are AppID.REGION_US_SOUTH, AppID.REGION_SYDNEY, or AppID.REGION_UK.AppID.REGION_US_SOUTH, AppID.REGION_SYDNEY, or AppID.REGION_UK.
